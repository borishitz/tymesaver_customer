...
public class ShoppingCartController {
    ...
    public String addItemToCart(@RequestParam("id") Long id,
        ...
        ShoppingCart shoppingCart = cartService.addItemToCart(tripDto, quantity, username);
    ...
    public String updateCart(@RequestParam("id") Long id,
        ...
        TripDto tripDto = tripService.getById(id);
        String username = principal.getName();
        ShoppingCart shoppingCart = cartService.updateCart(tripDto, quantity, username);
        model.addAttribute("shoppingCart", shoppingCart);
        session.setAttribute("totalItems", shoppingCart.getTotalItems());
    ...
    public String deleteItem(@RequestParam("id") Long id,
        ...
        if (principal == null) {
            ...
            TripDto productDto = tripService.getById(id);
            String username = principal.getName();
